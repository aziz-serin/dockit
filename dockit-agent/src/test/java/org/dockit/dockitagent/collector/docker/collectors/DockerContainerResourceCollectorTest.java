...
public class DockerContainerResourceCollectorTest {
    private Collector collector;

    @Before
    public void setup() {
        Injector injector = GuiceTestInitialise.injector();
        collector = injector.getInstance(DockerContainerResourceCollector.class);
    }
    ...
    public void collectReturnsJsonParsableData() {
        ...
        assertThat(dataJson).containsKey("memory_stats");
    }
}
