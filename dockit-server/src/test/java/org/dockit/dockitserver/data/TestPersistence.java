package org.dockit.dockitserver.data;
...
public class TestPersistence {
    ...
    // Persistence objects.
    private final static String PACKAGES = "org.dockit.dockitserver.entities";

    // Connection properties.
    private final static String DB_PATH = "mem:dockitserver-test";
    ...
    private final static String H2_USERNAME = "test";
    private final static String H2_PASSWORD = "test";
