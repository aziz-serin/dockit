...
public class VmCpuUsageAnalyzerTest {
    @Autowired
    private VmCpuUsageAnalyzer vmCpuUsageAnalyzer;
    ...
    public void analyzeReturnsAlertGivenImportantCpuLoad() {
        List<Alert> alerts = vmCpuUsageAnalyzer.analyze(alertAudit);
    ...
    public void analyzeDoesNotReturnAlertGivenUnImportantCpuLoad() {
        List<Alert> alerts = vmCpuUsageAnalyzer.analyze(noAlertAudit);
