...
public class AlertMessageTemplates {
    ...
    public static final String VM_USERS_MESSAGE = "VM with vmId %s detected an intrusion by an unknown user" +
            " with user_name %s and host %s logged in at %s. ALERT LEVEL: %s";
}
